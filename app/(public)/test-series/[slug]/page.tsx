      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <section>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-text dark:text-white tracking-tight leading-tight mb-6">
              {data.title || "Untitled Test Series"}
            </h1>
            <p className="text-lg text-text-muted dark:text-gray-300 max-w-2xl leading-relaxed mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {stats.map((stat: any, idx: any) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`bg-surface dark:bg-[#121c28] p-6 rounded-2xl text-center border border-gray-200/20 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow ${stat?.highlight ? "border-b-4 border-b-emerald-500 dark:border-b-emerald-400 relative overflow-hidden" : ""}`}
                    >
                      {stat?.highlight && (
                      ...
                      <Icon
                        ...
                        size={28}
                      />
                      <div className="text-2xl font-extrabold text-text dark:text-white mb-1">
                        {stat?.value || "-"}
                      </div>
                      <div className="text-[11px] font-bold text-text-muted dark:text-gray-400 uppercase tracking-widest">
                        {stat?.label || "Stat"}
                      </div>
                    </div>
                  );
          ...
          {analytics.length > 0 && (
            <section className="bg-background dark:bg-[#121c28] rounded-3xl p-8 md:p-10 shadow-xl border border-gray-200/20 dark:border-white/5 relative overflow-hidden">
                  ...
                  {analytics.map((item: any, idx: any) => {
                    ...
                    return (
                      <div key={idx} className="space-y-4">
                        ...
                        <h3 className="font-bold text-lg text-text dark:text-white">
          ...
          {phases.length > 0 && (
            <section>
              <div className="flex items-center justify-between mb-8 border-b border-gray-200/20 dark:border-white/10 pb-4">
                  ...
                  >
                    <div className="flex items-center justify-between py-4 group-hover:px-4 transition-all duration-300">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h4 className="font-bold text-lg text-text dark:text-gray-200 group-hover:text-primary dark:group-hover:text-[#b5c4ff] transition-colors mb-1">
                            {phase?.title || "Phase"}
                          </h4>
                      ...
                      <Plus
                        size={20}
                        className="text-text-muted dark:text-gray-500 transition-transform group-hover:rotate-90 group-hover:text-primary shrink-0 ml-4"
                      />
                    </div>
                  </div>
                ))}
          ...
          {reviews.length > 0 && (
            <section className="space-y-10">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-gray-200/20 dark:border-white/10 pb-6">
                <div>
                  <h2 className="text-3xl font-extrabold text-text dark:text-white tracking-tight mb-2">
                    The Student Voice
                  </h2>
                ...
                <div className="flex items-center gap-3 bg-surface dark:bg-[#121c28] border border-gray-200/20 dark:border-white/5 px-5 py-3 rounded-full shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {reviews.map((review: any, idx: any) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="bg-background dark:bg-[#121c28] p-8 rounded-2xl space-y-5 border border-gray-200/20 dark:border-white/5 shadow-sm hover:shadow-md transition-shadow flex flex-col"
                    >
                      ...
                      <p className="text-sm text-text-muted dark:text-gray-300 italic leading-relaxed flex-grow">
        ...
        <div className="lg:col-span-4">
          <aside className="sticky top-28 space-y-6">
            ...
            <div className="bg-background dark:bg-[#121c28] rounded-3xl overflow-hidden shadow-2xl border border-gray-200/20 dark:border-white/10">
              <div className="relative h-48 bg-surface dark:bg-gray-800">
                {data.thumbnailUrl ? (
                  <img
              ...
              <div className="p-8">
                <div className="flex items-baseline gap-3 mb-6 flex-wrap">
                  ...
                  {fullPrice > discountedPrice && (
                    <>
                      <span className="text-lg text-text-muted dark:text-gray-500 line-through font-medium">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  {data.sampleLink && (
                    <a
                      ...
                      className="w-full flex items-center justify-center py-3.5 rounded-xl font-bold bg-surface dark:bg-white/5 text-text dark:text-gray-200 border border-gray-200/20 dark:border-white/5 hover:bg-surface dark:hover:bg-white/10 transition-colors text-sm"
                    >
                      View Sample Test
                    </a>
                  )}
            ...
            {isOfferValid && (
              <div className="bg-primary/5 dark:bg-primary/10 rounded-2xl p-6 border border-primary/10 dark:border-primary/20 shadow-sm">
                ...
                <div className="flex justify-between gap-3 text-center">
                  <div className="flex-1 bg-background dark:bg-[#121c28] rounded-xl py-3 border border-gray-200/20 dark:border-white/10 shadow-sm">
