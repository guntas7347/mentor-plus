    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
      ...
      <header className="mb-12 text-center md:text-left">
        <div className="flex flex-col space-y-4">
          <span className="text-primary dark:text-[#60a5fa] font-body font-bold tracking-widest text-xs uppercase">
          ...
          <p className="text-text-muted dark:text-gray-400 max-w-2xl text-base md:text-lg font-body leading-relaxed mx-auto md:mx-0">
      ...
      <div className="flex items-center space-x-2 mb-12 p-1.5 bg-surface dark:bg-[#1e2a3b] border border-gray-200/20 dark:border-white/5 rounded-2xl w-fit mx-auto md:mx-0 shadow-sm">
        ...
        <button className="px-8 py-3 text-text-muted dark:text-gray-400 hover:text-primary dark:hover:text-[#b5c4ff] font-semibold rounded-xl transition-all duration-300">
          Study Material
        </button>
      </div>
